...
# Upgrade pip, setuptools, and wheel before installing project dependencies to
# pull in versions that carry the latest security fixes for CVEs in older wheels
# shipped by the base python:3.10-slim image.
