...
class RunStore(Protocol):
    ...
    def list(self, user_id=None, agent_id=None, status=None, parent_run_id=None, limit=50, offset=0) -> List[Any]: ...
    def update(self, run_id: str, **fields) -> Optional[Any]: ...
...
class EventStore(Protocol):
    ...
    def list(self, run_id: str, after_sequence: int = 0, limit: int = 1000) -> List[Any]: ...
...
class HistoryProvider(Protocol):
    ...
    async def load(self, session_id, limit: int = 20) -> List[Dict[str, Any]]: ...